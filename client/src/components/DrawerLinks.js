...
export default function DrawerLinks({ toggleModal, closeDrawer, modalIsOpen }) {
    ...
    return (
        <div>
            ...
            <Link to='/shop' onClick={closeDrawer} className={classes.linkText}>
                <List>
            ...
            <Link to='/gallery' onClick={closeDrawer} className={classes.linkText}>
                <List>
                    <ListItem button key='Gallery'>
                        <ListItemText className={classes.listItemText} primary='Gallery' />
                    </ListItem>
                </List>
            </Link>
